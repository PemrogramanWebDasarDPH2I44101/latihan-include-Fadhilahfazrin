...
$_SESSION['pass'] = isset($_POST["pass"]) ? $_POST["pass"]:$_POST["pass"];//bisa muncul ketika tidak mengisi di halaman form
...
// }
$_SESSION['iduser'] = isset($_POST["1234"]) ? $_POST["1234"]:$_POST["1234"];
print_r($_SESSION);
?>
<br>
